...
export const mangakaApi = {
  ...
  getChapterNames: async (chapterId: string) => (await apiClient.get(`/chapters/${chapterId}/names`)).data?.data,
  ...
  getSeriesNames: async (seriesId: string, params?: any) => (await apiClient.get(`/series/${seriesId}/names`, { params })).data?.data,
  getAllSeriesNames: async (seriesId: string) => collectAllOffsetPages(async (page) => (await apiClient.get(`/series/${seriesId}/names`, { params: page })).data?.data),
  getSeriesName: async (seriesId: string, nameId: string) => (await apiClient.get(`/series/${seriesId}/names/${nameId}`)).data?.data,
  getChapterName: async (chapterId: string, nameId: string) => (await apiClient.get(`/chapters/${chapterId}/names/${nameId}`)).data?.data,
